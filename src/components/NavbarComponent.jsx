      ...
      <div className="flex items-center py-4 pl-4 pr-10">
        ...
        <div className="w-full flex justify-between ">
          ...
          >
            ...
            <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium rounded-3xl bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                ...
                >
                  ...
                  <span
                    className={`${
                      pathname.startsWith("/todo-list") ? "text-blue-700 " : "text-gray"
                    } text-lg`}
                  >
                    List
                  </span>
              ...
              <li>
                ...
                >
                  ...
                  <span
                    className={`${
                      pathname.startsWith("/todo-board") ? "text-blue-700" : "text-gray"
                    } text-lg`}
                  >
                    Board
                  </span>
            ...
            <div className={`${pathname.startsWith("/todo-list") ? "border-b-2 border-b-blue-700 absolute bottom-0 w-20 left-2" : "border-b-2 border-b-blue-700 absolute bottom-0 w-90 left-24"}`}></div>
          </div>
        </div>
      </div>
    </nav>
