import { insertNewTaskService } from "@/service/workspace.service";
...
export default function AddNewTaskComponent( {workSpaceId} ) {
  ...
  async function handleAddNewTask ( task ) {
    'use server'

    const dueDate = new Date(task.get('dueDate'));
    const newTask = {
    ...
    const res = await insertNewTaskService(newTask);
    ...
    <div>
      ...
      <div className="modal" role="dialog">
        <div className="modal-box">
          ...
          <form className="space-y-1" action={handleAddNewTask}>
            {/* title */}
